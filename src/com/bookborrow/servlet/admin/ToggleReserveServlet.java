...
@WebServlet("/admin/toggleReserve")
public class ToggleReserveServlet extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try (Connection conn = DBUtil.getConnection();
             PreparedStatement ps = conn.prepareStatement("UPDATE rjgc_books SET is_reserved=? WHERE id=?")) {
            ps.setInt(1, value);
            ps.setInt(2, id);
            ps.executeUpdate();
